...
class PostService:
    ...
    def create_post(self, post: PostCreate, writer: str):
        new_post = post.dict()
    ...
    def update_post(self, post_id: int, update_data: PostUpdate, user_nickname: str):
        for post in posts_db:
            if post["id"] == post_id:
                if post["writer"] != user_nickname:
                    return "FORBIDDEN"
    ...
    def delete_post(self, post_id: int, user_nickname: str):
